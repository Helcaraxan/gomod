...
This functionality requires the [`dot` tool](https://www.graphviz.org/) which you will need to install separately. 
You can produce images in GIF, JPG, PDF, PNG and PS format.
